...
export const MATCHES: Match[] = [
  {
    ...
    stats: [
      { label: "Possession", home: "58%", away: "42%", homeShare: 0.58 },
      { label: "Shots", home: "14", away: "9", homeShare: 14 / 23 },
      { label: "On target", home: "6", away: "4", homeShare: 0.6 },
      {
      ...
      { label: "Corners", home: "7", away: "3", homeShare: 0.7 },
      { label: "Fouls", home: "9", away: "12", homeShare: 9 / 21 },
    ],
    lineups: {
      home: {
        formation: "4-2-3-1",
